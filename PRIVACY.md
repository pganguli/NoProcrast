...
- Per-domain session state: a single timestamp recording when your current visit window started, used solely to enforce your configured limits
...
| `webNavigation` | Detect navigations to tracked sites in order to check and enforce session windows |
